...
# user blueprint
users = Blueprint('users', __name__, url_prefix ='/api/v1/users')    # users blueprint
    ...
    try:
        ...
        for author in all_authors:
            ...
            if hasattr(author,'books'):
                author_info['books']=[{'id':book.id, 'title':book.title,'price':book.price, 'genre':book.genre, 'price_unit':book.price_unit, 'description':book.description,'publication':book.publication_date,'image':book.image,'created_at':book.created_at} for book in author.books] 
...
def getUser(id):
    ...
    try:
        ...
        if hasattr(user,'books'):
                books = [{'id':book.id, 'title':book.title,'price':book.price, 'genre':book.genre, 'price_unit':book.price_unit, 'description':book.description,'publication':book.publication_date,'image':book.image,'created_at':book.created_at} for book in user.books] 
